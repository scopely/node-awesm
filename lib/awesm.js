(function() {
  ...
  AweSM = (function() {
    ...
    AweSM.prototype.createEndpoint = function(url, channel, tool, metaObject, callback, format, v) {
      ...
      return this.callAweSM('/url', url, channel, tool, metaObject = null, format, v, callback);
    };
    AweSM.prototype.createStaticEndpoint = function(url, channel, tool, metaObject, callback, format, v) {
      ...
      return this.callAweSM('/url/static', url, channel, tool, metaObject = null, format, v, callback);
    };
